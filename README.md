...
O EXE fica em `artifacts\NetworkMonitor-Setup-1.2.4.exe`. E so enviar esse arquivo.
...
- Varios sockets do mesmo aplicativo para o mesmo IP e porta viram uma linha, com a velocidade somada
